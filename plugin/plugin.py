...
class NetSpeedTestScreen(Screen):
    skin = '  <screen name="NetSpeedTestScreen"  backgroundColor="#380038" position="center,center" size="900,520" title="Net Speed Test" >\n                <ePixmap position="0,0"  size="900,520" pixmap="%s/SystemPlugins/NetSpeedTest/netspeed.jpg"     zPosition="1" transparent="1" alphaTest="blend" />\n                <widget name="data" position="155,59" zPosition="4" size="610,243" font="Regular;25" foregroundColor="#76addc" transparent="1" horizontalAlignment="left" verticalAlignment="top" />\n                <widget name="ping" position="190,29" zPosition="4" size="157,40" font="Regular;25" foregroundColor="white" transparent="1" horizontalAlignment="left" verticalAlignment="top" />\n                <widget name="host" position="673,453" zPosition="4" size="196,56" font="Regular;25" foregroundColor="white" transparent="1" horizontalAlignment="left" verticalAlignment="top" />\n                <widget name="ip" position="63,452" zPosition="4" size="204,53" font="Regular;25" foregroundColor="white" transparent="1" horizontalAlignment="left" verticalAlignment="top" />\n                <widget name="download" position="398,30" zPosition="4" size="156,53" font="Regular;25" foregroundColor="white" transparent="1" horizontalAlignment="left" verticalAlignment="top" />\n                <widget name="upload" position="597,30" zPosition="4" size="161,53" font="Regular;25" foregroundColor="white" transparent="1" horizontalAlignment="left" verticalAlignment="top" />\n                                                       \n\t\t</screen>' % resolveFilename(SCOPE_PLUGINS)
